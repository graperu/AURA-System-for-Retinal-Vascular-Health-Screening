  ...
  vi: {
    ...
    doctor: {
      ...
      consultation: {
        ...
        subtitle: "Trao đổi chuyên môn lâm sàng hai chiều thời gian thực qua kênh tư vấn trực tiếp.",
    ...
    admin: {
      ...
      templates: {
        ...
        inAppChannelLabel: "Kênh Thông Báo Ứng Dụng",
        emailChannelLabel: "Kênh Thư Điện Tử Email",
        smsChannelLabel: "Kênh Tin Nhắn SMS Khẩn Cấp",
  ...
  en: {
    ...
    doctor: {
      ...
      consultation: {
        ...
        safetyWarningText: "Real-time clinical communication channel. Not intended for medical emergencies.",
    ...
    clinic: {
      ...
      batchUploadModal: {
        ...
        quickDemoTitle: "Quick clinical test",
    ...
    admin: {
      ...
      templates: {
        ...
        retentionLabel: "Notification Retention Period in Days",
