      ...
      <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-1.5 h-10 p-1 bg-slate-100 rounded-xl border border-slate-200">
              <button
                ...
                className={`text-xs font-semibold rounded-lg transition-all cursor-pointer flex items-center justify-center ${
                  eyePosition === 'OD'
                    ? 'bg-white text-[#0891B2] shadow-xs border border-cyan-200 font-bold'
            ...
            <FormField label={isVi ? 'HA Tâm thu' : 'Systolic BP'}>
              <div className="relative">
                <input
                  ...
                  placeholder="120"
                  className="w-full h-10 pl-3 pr-11 rounded-xl border border-slate-200 bg-white text-slate-900 text-xs sm:text-sm font-mono-data focus:outline-none focus:border-[#0891B2] focus:ring-2 focus:ring-[#0891B2]/15 transition-all"
                />
            ...
            <FormField label={isVi ? 'HbA1c' : 'HbA1c'}>
              <div className="relative">
                <input
                  ...
                  placeholder="5.7"
                  className="w-full h-10 pl-3 pr-8 rounded-xl border border-slate-200 bg-white text-slate-900 text-xs sm:text-sm font-mono-data focus:outline-none focus:border-[#0891B2] focus:ring-2 focus:ring-[#0891B2]/15 transition-all"
                />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-1.5 border-t border-slate-200/80">
            <button
              ...
              className={`flex items-center justify-between p-2.5 rounded-xl border transition-all cursor-pointer text-left ${
                hasDiabetes
                  ? 'bg-teal-50 border-teal-300 text-teal-900 ring-1 ring-teal-400/30'
            ...
            >
              ...
              <div
                className={`w-4 h-4 rounded flex items-center justify-center transition-colors ${
                  hasDiabetes ? 'bg-teal-600 text-white' : 'border border-slate-300 bg-white'
                }`}
              >
            ...
            >
              ...
              <div
                className={`w-4 h-4 rounded flex items-center justify-center transition-colors ${
                  hasHypertension ? 'bg-teal-600 text-white' : 'border border-slate-300 bg-white'
                }`}
              >
            ...
            >
              ...
              <div
                className={`w-4 h-4 rounded flex items-center justify-center transition-colors ${
                  historyOfSmoking ? 'bg-teal-600 text-white' : 'border border-slate-300 bg-white'
                }`}
              >
        ...
        <FormField label={isVi ? 'Triệu chứng hiện tại hoặc ghi chú cho Bác sĩ (tùy chọn)' : 'Current symptoms or notes for doctor (optional)'}>
          <textarea
            ...
            className="w-full p-3 bg-white border border-slate-200 rounded-xl text-xs sm:text-sm text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-[#0891B2] focus:ring-2 focus:ring-[#0891B2]/15 transition-all resize-none"
          />
        </FormField>
        ...
        <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-100">
          ...
          <Button
            ...
            className="rounded-xl px-6 font-bold shadow-xs bg-[#0891B2] hover:bg-[#0E7490]"
          >
