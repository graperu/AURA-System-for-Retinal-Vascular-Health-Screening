...
export const Sidebar: React.FC<SidebarProps> = ({
        ...
        return [
          ...
          },
          {
            ...
            items: [
              ...
              {
                id: 'billing',
                label: t('navigation.billingCredits', isVi ? 'Gói cước & Lượt khám' : 'Credits & Plans'),
                icon: CreditCard,
              },
            ],
          },
        ...
        return [
          ...
          },
          {
            ...
            items: [
              ...
              {
                id: 'credit-package',
                label: t('navigation.creditPackage', isVi ? 'Gói cước & Lượt khám' : 'Quota & Plans'),
                icon: CreditCard,
              },
            ],
          },
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-[236px] flex-col border-r border-[#EAECF0] bg-white transition-transform duration-200 lg:translate-x-0 ${
          isOpen ? 'translate-x-0 shadow-xl' : '-translate-x-full'
        } ${className}`}
        aria-label={isVi ? 'Điều hướng chính' : 'Main navigation'}
      >
        {/* Top Clinical Brand Logo */}
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`group flex w-full items-center justify-between rounded-xl px-3.5 py-2.5 text-xs font-semibold transition-colors duration-150 ${
                        isActive
        ...
        {/* Bottom Pinned Log Out Button */}
        {onLogout && (
          <div className="p-4 border-t border-[#EAECF0] bg-white">
            <button
              type="button"
              onClick={onLogout}
