...
export const patientNavigation = [
  ...
  { id: "family", label: "Hồ sơ gia đình", icon: Users },
  { id: "privacy", label: "Quyền dữ liệu", icon: Shield },
  { id: "guide", label: "Hướng dẫn chụp & Chatbot", icon: Camera },
];
