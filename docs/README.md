...
- `04-database`: schema design and data dictionary
- `05-api`: backend and AI contracts and error codes
- `07-testing`: test plan and test cases
- `08-deployment`: local setup, environment variables, and deployment
