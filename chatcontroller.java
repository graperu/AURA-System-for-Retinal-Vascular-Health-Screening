...
public class ChatController {
  ...
  @PreAuthorize("isAuthenticated()")
  @Operation(summary = "Get list of recent conversations for the current user")
  public ApiResponse<List<com.aura.chat.dto.ConversationSummaryResponse>> getConversations(
      @AuthenticationPrincipal AuraUserPrincipal principal) {
    List<com.aura.chat.dto.ConversationSummaryResponse> summaries =
        chatService.getRecentConversations(principal.getId());
