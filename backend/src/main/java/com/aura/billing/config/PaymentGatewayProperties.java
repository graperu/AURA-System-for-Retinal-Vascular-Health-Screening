...
public record PaymentGatewayProperties(
  ...
  public PaymentGatewayProperties() {
    this(VnPayProperties.createDefault(), MomoProperties.createDefault(), VietQrProperties.createDefault(), "AURA_BILLING_WEBHOOK_SECRET_2026", true);
  }

  public PaymentGatewayProperties(VnPayProperties vnpay, MomoProperties momo, boolean sandboxMode) {
    this(vnpay, momo, VietQrProperties.createDefault(), "AURA_BILLING_WEBHOOK_SECRET_2026", sandboxMode);
  }
  ...
  public PaymentGatewayProperties(
      ...
      String webhookSecret,
      boolean sandboxMode) {
    this.vnpay = vnpay != null ? vnpay : VnPayProperties.createDefault();
    this.momo = momo != null ? momo : MomoProperties.createDefault();
    this.vietqr = vietqr != null ? vietqr : VietQrProperties.createDefault();
  ...
  public record VietQrProperties(
    ...
    public static VietQrProperties createDefault() {
      return new VietQrProperties("MB", "1208123456", "PHAN VAN DINH", "compact2");
    }
  ...
  public record VnPayProperties(
    ...
    public static VnPayProperties createDefault() {
      return new VnPayProperties("AURA_VNPAY_TMN_DEMO", "AURA_VNPAY_HASH_SECRET_KEY_DEMO_2026",
  ...
  public record MomoProperties(
    ...
    public static MomoProperties createDefault() {
      return new MomoProperties("MOMO_AURA_MERCHANT_2026", "MOMO_ACCESS_KEY_AURA_DEMO",
