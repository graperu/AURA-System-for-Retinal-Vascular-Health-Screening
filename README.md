...
* **Hình Ảnh Võng Mạc Là Chỉ Số Sức Khỏe Không Xâm Lấn:** Hệ thống tận dụng mắt như một "cửa sổ" nhìn vào sức khỏe hệ thống, sử dụng hình thái mạch máu võng mạc để ước tính nguy cơ tăng huyết áp, biến biến chứng tiểu đường và đột quỵ — chuyển đổi các buổi khám mắt định kỳ thành một công cụ rộng hơn để sàng lọc nguy cơ bệnh tật.
